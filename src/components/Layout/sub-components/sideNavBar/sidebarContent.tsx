...
const sidebarContent: SidebarContentType[] = [
    {
        ...
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                <path d="M1 16.43V12.18" stroke="#4B4B4D" stroke-width="2" stroke-linecap="round"
                      stroke-linejoin="round"/>
                <path d="M6.33002 16.43V9.07001" stroke="#4B4B4D" stroke-width="2" stroke-linecap="round"
                      stroke-linejoin="round"/>
                <path d="M11.67 16.43V12.18" stroke="#4B4B4D" stroke-width="2" stroke-linecap="round"
                      stroke-linejoin="round"/>
                <path d="M17 16.43V7.31" stroke="#4B4B4D" stroke-width="2" stroke-linecap="round"
                      stroke-linejoin="round"/>
                <path d="M1 6.31L6.33 2.66L11.67 5.86L17 1" stroke="#4B4B4D" stroke-width="2" stroke-linecap="round"
                      stroke-linejoin="round"/>
            </svg>
        ),
        name: "Reports",
    ...
    },
    {
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" viewBox="0 0 22 24" fill="none">
                <path d="M5.88867 6.0002H15.6664" stroke="#4B4B4D" stroke-width="2" stroke-linecap="round"
                      stroke-linejoin="round"/>
                <path d="M5.88867 10.8002H15.6664" stroke="#4B4B4D" stroke-width="2" stroke-linecap="round"
                      stroke-linejoin="round"/>
                <path
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="19" height="24" viewBox="0 0 19 24" fill="none">
                <g clip-path="url(#clip0_631_123)">
                    <path
                        ...
                        fill="#222224"/>
                    <path d="M4.90002 8.66H13.5" stroke="#8247F6" stroke-width="2" stroke-linecap="round"
                          stroke-linejoin="round"/>
                    <path d="M4.90002 13.75H13.5" stroke="#8247F6" stroke-width="2" stroke-linecap="round"
                          stroke-linejoin="round"/>
                    <path
                        ...
                        stroke="#222224" stroke-width="2" stroke-miterlimit="10"/>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="19" viewBox="0 0 24 19" fill="none">
                <g clip-path="url(#clip0_631_161)">
                    <path
                        ...
                        stroke="#4B4B4D" stroke-width="2" stroke-miterlimit="10"/>
                    <path d="M21.54 3.18H1.87L2.47 1.55L21.19 1.27L21.54 3.18Z" stroke="#4B4B4D" stroke-width="1.9"
                          stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M18.26 7.27H13.19V9.81H18.26V7.27Z" fill="#4B4B4D" stroke="#4B4B4D" stroke-width="2"
                          stroke-linecap="round" stroke-linejoin="round"/>
                </g>
                <defs>
        ...
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path
                    ...
                    stroke="#4B4B4D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M1.33301 12H22.6663" stroke="#4B4B4D" stroke-width="2" stroke-linecap="round"
                      stroke-linejoin="round"/>
                <path d="M10.666 18.6667V22.6667H13.3327V18.6667" stroke="#4B4B4D" stroke-width="2"
                      stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <path
                    ...
                    fill="#4B4B4D" stroke="#4B4B4D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
        ),
        name: "Service",
        path: '/service'
