  ...
  },
  {
    icon: (
      ...
      >
        ...
        />
        <path
          d="M1 6.31L6.33 2.66L11.67 5.86L17 1"
          stroke="#4B4B4D"
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
    ...
    icon: (
      ...
      >
        <g clipPath="url(#clip0_631_123)">
          ...
          />
          <path
            d="M4.52002 1.18L7.09002 3.51H11.3L13.88 1.18H4.52002Z"
            fill="#222224"
            stroke="#222224"
            strokeWidth="2"
            strokeLinecap="round"
    ...
    icon: (
      ...
      >
        <g clipPath="url(#clip0_631_161)">
          ...
          />
          <path
            d="M21.54 3.18H1.87L2.47 1.55L21.19 1.27L21.54 3.18Z"
            stroke="#4B4B4D"
            strokeWidth="1.9"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
          <path
            d="M18.26 7.27H13.19V9.81H18.26V7.27Z"
            fill="#4B4B4D"
            stroke="#4B4B4D"
            strokeWidth="2"
            strokeLinecap="round"
