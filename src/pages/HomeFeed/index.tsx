...
import {DeleteIcon, DraggableIcon, EyeIcon, MobileIcon, MobileIcon2} from "@src/components/svg-icons";
...
const HomeFeed: FC = () => {
    return <Container>
        <Box className={'home-feed-content-left'}>
            <Box className={'upper-section'}>
                <Box display={'flex'} justifyContent={'space-between'} alignItems={'center'}>
                    <Box display={"flex"} alignItems={'center'} gap={'9px'} ml={'1rem'}>
                        <MobileIcon/>
                        <Typography fontSize={'1.75rem'} variant={'h5'} fontWeight={'bolder'}>
                            Home Feed
                        </Typography>
                    </Box>
                    <Box>
            ...
            <Box mt={'2rem'} display={'flex'} flexDirection={'column'} gap={'0.5rem'}>
                <ItemCard icon={<>☝️️</>}>
                    <Typography fontSize={'1.125rem'} fontWeight={'bold'}>
                        Call to Action
                    </Typography>
        ...
        <Box className={'home-feed-content-preview'}>
            <Box className={'home-feed-list'} mt={'3.0625rem'}>
                <ItemCard variant={'outlined'} iconStyles={{fontSize: '1rem'}} p={'0.75rem'} icon={<DraggableIcon/>}>
                    <Typography fontSize={'1.125rem'} fontWeight={'bold'}>
                ...
                <ItemCard variant={'outlined'} iconStyles={{fontSize: '1rem'}} p={'0.75rem'} icon={<DraggableIcon/>}
                    ...
                    <Box display={'flex'} alignItems={'center'} justifyContent={'space-between'}>
                        <Box flexGrow={1} display={'flex'} alignItems={'center'} gap={'0.75rem'}>
